...
class gps_msg {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.string(obj.UTC, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.UTC = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.UTC);
  ...
  static md5sum() {
    ...
    return '821f144385e2c1a035161ae5b52aaf26';
  }
